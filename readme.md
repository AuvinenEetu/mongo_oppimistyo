...
4. Pystytä kanta ja lisää esimerkkidatat seuraavilla komennoilla <p style="color:red">(HUOM!</p> Vaihda kontinnimi pystyttämäsi docker kontin nimeksi, minun tapauksessani mongo-server)</p>
